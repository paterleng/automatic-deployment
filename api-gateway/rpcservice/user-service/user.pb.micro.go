...
func (c *userService) CheckStatus(ctx context.Context, in *Request, opts ...client.CallOption) (*Response, error) {
	req := c.c.NewRequest(c.name, "UserService.CheckStatus", in)
	out := new(Response)
...
func (h *userServiceHandler) CheckStatus(ctx context.Context, in *Request, out *Response) error {
